...
namespace EasyIoc
{
    ...
    public class IocContainerFirstVersion : IIocContainerFirstVersion
    {
        ...
        private static readonly Lazy<IocContainerFirstVersion> LazyDefault = new Lazy<IocContainerFirstVersion>(() => new IocContainerFirstVersion());
        public static IIocContainerFirstVersion Default
        {
            get
            {
